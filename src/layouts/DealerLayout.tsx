      ...
      <AnimatePresence>
        {cartCount > 0 && page !== "CART" && (
          <motion.button
            ...
            onClick={() => setPage("CART")}
            className="fixed bottom-6 right-6 z-50 flex items-center justify-center p-4 bg-emerald-600 text-white rounded-full shadow-2xl shadow-emerald-600/40 hover:bg-emerald-700 transition-all hover:-translate-y-1 group"
          >
            <ShoppingCart size={28} />
            <span className="absolute -top-2 -right-2 min-w-[24px] h-[24px] px-1.5 bg-red-500 text-white text-xs font-black rounded-full flex items-center justify-center shadow-lg border-2 border-white">
